    ...
    <div className="side-tab-container">
      ...
      <div className="tab-content">
        {activeTab === 'profile' && <div>
            ...
            <form className='profile-form'>
              <div className='profile-name'>
                <input type='text' placeholder='First Name' className='profile-first-name'></input>
                <input type='text' placeholder='Last Name' className='profile-last-name'></input>
              </div>
              {/* <p className='profile-email'>Email Address</p> */}
              <h3 className='profile-heading'>Email Address</h3>
              <div className='profile-name'>
                <input type='text' placeholder='Email Address' className='profile-email'></input>
              </div>
              <h3 className='profile-heading'>Mobile Number</h3>
              <div className='profile-name'>
                <input type='text' placeholder='Mobile Number' className='profile-email'></input>
              </div>
        ...
        {activeTab === 'cards' && <div>
            ...
            <p className='faq-ans'>A token is generated when a user gives consent to Flipkart to tokenise their card. A token is a unique value for a combination of card, token requestor (Flipkart is a token requestor & accepts request from the customer for tokenisation of a card and passes it onto the card network to issue a corresponding token) and device. The token does not contain any personal information linked to your card and is generated only when a customer uses a new card for a successful transaction on Flipkart.</p>
            <br/>
            <b><p>Is it safe to tokenise my card?</p></b>
            <p className='faq-ans'>Yes. A tokenised card transaction is considered safer as the actual card details are not shared with the Flipkart during transaction processing . Card information is stored with the authorised card networks or card issuers only and Flipkart does not store your 16-digit card number.</p>
            <br/>
