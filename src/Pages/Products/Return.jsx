...
const Return = () => {
  ...
  return (
    ...
    <div className='return_full_page'>
        <div className='return_inner'>
            <h3 className='return_heading'>CANCELLATION, RETURN AND REFUND POLICY</h3>
            <div className='return-inner-text'>
            <p>
            <b>Reliance Retail Limited</b>, a company incorporated under the laws of India, having its registered office at 3rd Floor, Court House, Lokmanya Tilak Marg, Dhobi Talao, Mumbai – 400 000, Maharashtra, India  is managing and operating the websites www.shopee.com (“<b>SHOPEE</b>”) and luxe.shopee.com and the corresponding mobile and tablet applications thereof through which it inter alia, offers various retail solutions, facilitates the online sale and purchase of a diverse range of products including lifestyle, fashion, clothing, appeal, footwear, accessories, electronic and  home appliances, beauty, toys and other products listed on the Platforms from time to time (“<b>Products</b>”) to the users of the Platforms  (“User” or “Users” or “you” or “your”).  
            <br/><br/>
            ...
            <br/>
            5. You agree that we will not accept the return of any Product: (i) if you have placed the order for a wrong product model, colour or incorrect Product, (ii) if the Product belongs to Non-Returnable Products (defined below), (iii) if you fail to request return/register a complaint in relation to a Non-Compliant Product within the AJIO Return Period (defined above) (iv) ‘Made to Order’ Products on the Platforms. Any damage to the Product caused by your improper wearing or safekeeping of the Product, or any modification or change to the Product by you or a third party or any depreciation in the value for other reasons will not deem such Product a Non-Compliant Product and will not be considered a quality problem. Any decision by us in this regard shall be final and binding.
            <br/>
            ...
            <br/>
            7. Reliance shall not accept return or refund requests raised for certain category of Products, including but not limited to the following Products, except in accordance with paragraph (m) below (“<b>Non-Returnable Products</b>”):
            <br/>
            <br/>
            (i) Swimwear
            <br/>
            ...
            <br/>
            <br/>
            1.At the time of raising a request for return or cancelling the Products on any of the Platforms, you may seek refund for the Non-Compliant Product. Such refund will be made to the you only in the event the payment has been received by us for the Products returned or cancelled.
            <br/>
            ...
            <br/>
            7. Reliance shall make all reasonable attempts to keep the User apprised of the status of refund through updates shared on the User’s account on the Platforms, registered mobile number and registered email address. Reliance disclaims all liabilities that may arise on account of its failure to keep the User apprised of the status of the refund due to any technical reason beyond the control of Reliance.
            <br/>
            ...
            <br/>
            <br/>
            <b>2.4 Exchange of Products:</b>
            <br/>
            <br/>
            1. You may initiate the request for exchange of the Product if the Product delivered is of different fit and/or size than the fit and/or size of Product that was ordered on the Platform or if the fit and/or size of the Product order does not fit the User and User wants to try a different (either larger or smaller) fit and/or size of the same Products (“<b>Exchangeable Product</b>”). You shall initiate such requests for an exchange of Exchangeable Product within such timelines mentioned in the Product detail page (“<b>Exchange Period</b>”).
            <br/>
            ...
            <br/>
            5. You can exchange the Product(s), purchased from us provided the Product(s) satisfy below mandatory conditions:
            <br/>
            <br/>
            ...
            <br/>
            (vi) In the case of electronics, if the Products sought to be returned are not sealed in the poly jiffy bag provided by Reliance.
            <br/>
            (vii) In case of precious materials or accessories (watches), if the returned Products are fake or counterfeit or damaged.
            <br/>
            (viii) Exchange is being initiated against the order under which it was bought and from same account and the serial number/ bar code of the Product matches our records.
            <br/>
            (ix) The gifts accompanying the purchased Product must be returned, or upon being returned, show signs of being used, washed, damaged or defect.
            <br/>
            (x) There is no foul odour, perfume, stains, dents, scratches, tears or damage on the Product.
            <br/>
            (xi) The Product(s) if bought as a set should be exchanged as the complete set.
            <br/>
            (xii) Products returned for exchange should be in unused, undamaged, unwashed and in a saleable condition.
            <br/>
            ...
            <b>Contact Details:</b>
            <br/>
            SHOPEE: customercare@shopee.com or Self Care section on SHOPEE Platform
            <br/>
            SHOPEE Luxe: customercare@shopee.com or Self Care section on SHOPEE Platform
            </p>
        </div>
        </div>
    </div>
